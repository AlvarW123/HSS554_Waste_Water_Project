...
# Perform GridSearchCV for parameter tuning with cross-validation
...
print("r2_train: "+str(best_model.score(X_train_scaled,Y_train)))
...
for i in range(1,7):
    ...
    plt.xlabel("index")
    plt.legend()
    plt.savefig("figures/Lasso/lasso_tank_"+str(i)+".png")
    plt.cla()
    ...
    plt.xlabel("index")
    plt.legend()
    plt.savefig("figures/Lasso/lasso_abs_diff_tank_"+str(i)+".png")